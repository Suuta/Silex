...
namespace Silex
{
    ...
    static HRESULT TrySetWindowCornerStyle(HWND hWnd, bool tryRound)
    {
        HRESULT hr = S_OK;
        ...
        //----------------------------------------------------------
        if (OS::GetContext().osBuildNumber >= 22000)
        {
#if 0
    ...
    Window::Window(const WindowCreateInfo& createInfo)
    {
        ...
        // ウィンドウ丸角スタイル
        TrySetWindowCornerStyle(GetWindowHandle(), createInfo.roundWindowCorner);
