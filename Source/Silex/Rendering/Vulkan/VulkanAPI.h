...
namespace Silex
{
    ...
    public:
        ...
        void BeginRenderPass(CommandBuffer* commandbuffer, RenderPass* renderpass, FramebufferHandle* framebuffer, CommandBufferType commandBufferType = COMMAND_BUFFER_TYPE_PRIMARY) override;
